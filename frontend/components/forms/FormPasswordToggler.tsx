  ...
  return (
    <div className="h-full">
      <label htmlFor="password">
        {label} <span className="text-gray-800 dark:text-cyan-400">*</span>
      </label>
      <div className="flex items-center h-full">
        ...
        <button
          type="button"
          className="bg-[#f0f0f0] dark:bg-[#090D1F] border-[#BDBDBD] dark:border-[#bdbdbd6f] border-2 rounded-md p-2 cursor-pointer ml-1 active:bg-slate-200 transition-all duration-300"
          onClick={() =>
